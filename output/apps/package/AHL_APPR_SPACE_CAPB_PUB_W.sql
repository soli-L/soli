...
CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AHL_APPR_SPACE_CAPB_PUB_W" as
  /* $Header: AHLWSPCB.pls 120.1 2006/05/02 07:18 sathapli noship $ */
  ...
  as
    ddp_x_space_rec ahl_appr_space_capb_pub.space_rec;
    ddp_x_space_capbl_tbl ahl_appr_space_capb_pub.space_capbl_tbl;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    ahl_appr_space_capb_pub_w.rosetta_table_copy_in_p3(ddp_x_space_capbl_tbl, p6_a0
      , p6_a1
      , p6_a2
      , p6_a3
      , p6_a4
    ...
    ahl_appr_space_capb_pub.process_space_capbl(p_api_version,
      p_init_msg_list,
      p_commit,
      p_validation_level,
      p_module_type,
    ...
    ahl_appr_space_capb_pub_w.rosetta_table_copy_out_p3(ddp_x_space_capbl_tbl, p6_a0
      , p6_a1
      , p6_a2
      , p6_a3
      , p6_a4
